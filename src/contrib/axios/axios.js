...
axios.abortAll = function () {
  inProgressRequests.abortAll();
};

axios.isRequestInProgress = function (requestId) {
  return !!inProgressRequests.getRequest(requestId);
};

axios.abort = function (requestId) {
  inProgressRequests.abortRequest(requestId);
};
// Expose defaults
